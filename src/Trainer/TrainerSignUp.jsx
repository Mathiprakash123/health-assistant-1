    ...
    <div className="flex min-h-screen bg-gray-100">
      <div className="flex bg-white m-auto items-center p-5 w-[80%] shadow-lg rounded-lg">
        ...
        <div className="flex flex-1 items-center justify-center">
          <form onSubmit={handleSubmit} className="rounded-lg w-full max-w-md p-8 space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="mb-6">
                <label htmlFor="name" className={`block mb-2 text-lg ${errors.name ? "text-red-500" : "text-gray-700"}`}>
                  {errors.name || "Name"}
                </label>
                <input
                  type="text"
                  id="name"
                  className={`p-3 rounded-lg w-full outline-none bg-gray-100 ${errors.name ? "border-red-500" : "border-gray-300"}`}
              ...
              <div className="mb-6">
                <label htmlFor="email" className={`block mb-2 text-lg ${errors.email ? "text-red-500" : "text-gray-700"}`}>
                  {errors.email || "Email"}
                </label>
                <input
                  type="email"
                  id="email"
                  className={`p-3 rounded-lg w-full outline-none bg-gray-100 ${errors.email ? "border-red-500" : "border-gray-300"}`}
              ...
              <div className="mb-6">
                <label htmlFor="password" className={`block mb-2 text-lg ${errors.password ? "text-red-500" : "text-gray-700"}`}>
                  {errors.password || "Password"}
                </label>
                <input
                  type="password"
                  id="password"
                  className={`p-3 rounded-lg w-full outline-none bg-gray-100 ${errors.password ? "border-red-500" : "border-gray-300"}`}
              ...
              <div className="mb-6">
                <label htmlFor="gender" className={`block mb-2 text-lg ${errors.gender ? "text-red-500" : "text-gray-700"}`}>
                  {errors.gender || "Gender"}
                </label>
                <select
                  id="gender"
                  className={`p-3 rounded-lg w-full outline-none bg-gray-100 ${errors.gender ? "border-red-500" : "border-gray-300"}`}
                  value={gender}
