...
import Image from '/src/assets/logo-no-background.png';
    ...
    <div className=" h-full w-[200px] fixed shadow-xl bg-white">
      ...
      <div>
        <Link to={"clients"}>
          ...
          <p className="text-gray-500 text-center text-xs  mt-2">Clients</p>
        </Link>
      </div>
      <div>
        <Link to={"trainer_payment"}>
          {" "}
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
          ...
          <p className="text-gray-500 text-center text-xs mt-2">Bills Section</p>
        </Link>
      </div>
    </div>
  );
